# -*- coding: utf-8 -*-
"""
Created on Mon Jan 15 20:58:15 2018
...
def ResNet50(input_shape = (64, 64, 3), classes = 6):
    ...
    X=X=multiple_identity_block(X,3,[128,128,512],stage=3,block=1,iterator=7)
    print(X.shape)
    # Stage 4 (≈6 lines)
    X = convolutional_block(X, f = 3, filters = [256,256,1024], stage = 4, block=1, s = 2)
    X=multiple_identity_block(X,3,[256,256,1024],stage=4,block=1,iterator=35)
    print(X.shape)    
